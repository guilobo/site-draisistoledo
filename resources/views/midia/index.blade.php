...
<head>
    ...
    <x-seo.head
        title="Na Mídia — Participações em TV, Rádio e Podcasts"
        description="Dra. Isis Toledo na mídia — participações em TV, rádio, podcasts e portais de notícias. Especialista em endocrinologia e gestão metabólica."
    />

    <x-seo.schema type="media-index" />
