...
<head>
    ...
    <meta name="description" content="{{ $post->seo_description ?? $post->excerpt ?? 'Artigo da Dra. Isis Toledo — Endocrinologista e Metabologista em Florianópolis.' }}">
...
<body class="bg-warm-white font-sans text-brand-900 antialiased">
    ...
    <section class="py-16 bg-brand-900">
        <div class="max-w-3xl mx-auto px-6 lg:px-8 text-center">
            ...
            <a href="https://wa.me/5548999344088?text=Olá,%20li%20um%20artigo%20e%20gostaria%20de%20agendar%20uma%20avaliação"
               target="_blank" rel="noopener noreferrer"
               class="btn-gold">
